...
function inject (bot) {
  ...
  bot.npcsNames = fs.readFileSync(path.join(__dirname, '../../data/monster_names.txt'), 'utf8').split('\n')
  bot.areaNames = fs.readFileSync(path.join(__dirname, '../../data/areas.txt'), 'utf8').split('\n')
